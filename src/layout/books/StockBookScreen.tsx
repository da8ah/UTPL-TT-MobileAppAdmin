		...
		<Layout style={[styles.common, styles.bodyMiddle]}>
			...
			>
				...
				<Layout style={{ width: "10%", justifyContent: "center", alignItems: "flex-end" }}>
					...
					>
						{!props.isEditionActive ? (
							<Icon name={visible ? "eye-outline" : "eye-off-outline"} fill={visible ? "orange" : "darkgray"} height="35" width="35" />
						) : (
							<Icon name={visible ? "eye" : "eye-off"} fill={visible ? "orange" : "darkgray"} height="35" width="35" />
						)}
					</TouchableOpacity>
				</Layout>
			</Layout>
